  ...
  return (
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl"
          src="https://plus.unsplash.com/premium_photo-1669559809532-1d67e4ac58b5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGRlc3NlcnRzfGVufDB8fDB8fHww"
          alt="/"
        />
      </div>
    </div>
